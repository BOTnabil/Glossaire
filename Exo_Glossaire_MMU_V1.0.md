...
- Il s'agit d'une variable prédéfinies et toujours disponibles à l'utilisation, il en existe 9. Exemple :
    
- echo 'Bonjour ' . htmlspecialchars($_POST["name"]);


- Ici on affiche un texte où apparait un nom qui sera rentré au préalable par l'utilisateur par la variable $_POST.
